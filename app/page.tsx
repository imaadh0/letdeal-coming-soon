...
export default function Home() {
  return (
    <main className="relative h-[100dvh] w-full bg-black overflow-hidden">
      ...
      <Image
        src="/fix deal.jpg"
        alt="Fix Deal Coming Soon Mobile"
        fill
        className="object-contain sm:hidden z-10"
        priority
      />
      ...
      {/* Desktop/Tablet Image (PNG) */}
      <Image
        src="/Fix deal.png"
        alt="Fix Deal Coming Soon Desktop"
        fill
        className="hidden sm:block object-contain z-10"
        priority
      />

      {/* 
      <div className="relative flex min-h-screen flex-col items-center justify-start overflow-hidden bg-[#230064] px-4 pt-20 pb-12 text-white transition-colors duration-500 sm:px-6 sm:pt-24 lg:px-8 xl:justify-start xl:pt-0">
